...
The `--output-hashing=bundles` option is a configuration setting used in Angular CLI during the build process. It controls how the build output files are hashed.
